...
@Component({
  selector: 'app-established_Company',
  templateUrl: './established_Company.component.html',
  styleUrls: ['./established_Company.component.scss'],
 })
export class established_Company extends RootComponent implements OnInit {
  tableData: Array<any>;
  searchCeritria = '';
  dataListSize = 0;
  loading = true ;
