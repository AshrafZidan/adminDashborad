...
@Component({
  selector: 'app-custom_Clearance',
  templateUrl: './custom_Clearance.component.html',
  styleUrls: ['./custom_Clearance.component.scss'],
 })
export class custom_ClearanceComponent extends RootComponent implements OnInit {
  tableData: Array<any>;
  searchCeritria = '';
  dataListSize = 0;
  loading = true ;
