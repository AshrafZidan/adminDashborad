...
@Component({
  selector: 'app-feasability_Study',
  templateUrl: './feasability_Study.component.html',
  styleUrls: ['./feasability_Study.component.scss'],
 })
export class feasability_StudyComponent extends RootComponent implements OnInit {
  tableData: Array<any>;
  searchCeritria = '';
  dataListSize = 0;
  loading = true ;
