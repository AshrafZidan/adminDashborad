...
@Component({
  selector: 'app-trading_Agencies',
  templateUrl: './trading_Agencies.component.html',
  styleUrls: ['./trading_Agencies.component.scss'],
 })
export class trading_AgenciesComponent extends RootComponent implements OnInit {
  tableData: Array<any>;
  searchCeritria = '';
  dataListSize = 0;
  loading = true ;
  ...
  loadData(pageSize  , pageNumber , searchCeritria) {
    this.loading = true;
      ...
      this.service.GetTradingAgencies( pageSize , pageNumber ,searchCeritria  ).subscribe(res => {
