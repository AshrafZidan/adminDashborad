...
@Component({
  selector: 'app-certified_Translations',
  templateUrl: './certified_Translations.component.html',
  styleUrls: ['./certified_Translations.component.scss'],
 })
export class certified_TranslationsComponent extends RootComponent implements OnInit {
  tableData: Array<any>;
  searchCeritria = '';
  dataListSize = 0;
  loading = true ;
