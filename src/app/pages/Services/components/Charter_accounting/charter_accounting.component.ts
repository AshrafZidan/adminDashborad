...
@Component({
  selector: 'app-charter_accounting',
  templateUrl: './charter_accounting.component.html',
  styleUrls: ['./charter_accounting.component.scss'],
 })
export class charter_accountingComponent extends RootComponent implements OnInit {
  tableData: Array<any>;
  searchCeritria = '';
  dataListSize = 0;
  loading = true ;
